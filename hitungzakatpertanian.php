...
if(isset($_POST['hitung'])){
  ...
  if($hasilpanen>=520){
      ...
      $total=($hasilpanen*0.1)*$hargapanen;
...
<style>
  .kosong{
    color: red;
          ...
          <h3>Hitung Zakat Pertanian Makanan Pokok</h3>
          <ol>
          <li>Masukan jumlah hasil panen dalam satuan Kg dengan nisob minimal 520 Kg (beras)</li>
          <li>Masukan Harga hasil panen per Kg</li>
