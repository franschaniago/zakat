					...
					<table id="muzakki" class="table table-bordered">
		                ...
		                <tr>
		                    ...
		                    <td><?php echo  $a['nama_amil']; ?></td>
		                     <td><a href="edit_mustahiq.php?id=<?= $a['id'];?>" name="simpan" class="btn btn-primary">Edit</td>
		                    <td><a href="hapus_mustahiq.php?id=<?= $a['id'];?>" onclick="return confirm('Data akan dihapus ?')" name="simpan" class="btn btn-danger">Hapus</td>
		                </tr>
		                    <?php
		                    $no++;
		                    }
