...
if(empty($id=$_GET['ids']) AND empty($id_user=$_GET['id_user'])){
	echo "id kosong";
}else{
...
if(isset($_POST['submit'])){
		...
		if(updatepesan($id,$id_user,$balasan,$status)){
...
<?php while ($a=mysqli_fetch_assoc($result)) { ?>
  ...
  <div class="form-group">
    ...
    <input readonly type="text" class="form-control" value="<?= $a['nama_user'];?>">
  </div>
  <div class="form-group">
    <label >Pesan</label>
