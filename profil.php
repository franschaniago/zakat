...
?>
  ...
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#menu1">Zakat Anda <?php $total=mysqli_num_rows($result2); echo "<strong>".$total."</strong>"; ?></a></li>
    <li><a data-toggle="tab" href="#menu2">Konfirmasi Zakat 
    <?php $total=mysqli_num_rows($result4); echo "<strong>".$total."</strong>"; ?></a></li>
    <li><a data-toggle="tab" href="#menu3">Transaksi Di Tolak <?php $total=mysqli_num_rows($result5); echo "<strong>".$total."</strong>"; ?></a></li>
  </ul>
    ...
    <div id="home" class="tab-pane fade in active">
    	<div class="panel panel-default">
  			...
  			<div class="panel-body">
				...
				<div class="col-md-9">
			        <p><h3><?= ucwords($row['namalengkap'])?></h3></p>
					...
					<table id="transaksi" class="table table-bordered">
		                ...
		                <tr>
		                    ...
		                    <td><?php if($a['status']=="2"){ ?>
		                    	...
		                    	"Nama				: ".$a['nama']."<br>".
		                    	"Jenis Transaksi	: ".$a['jenis_transaksi']."<br>".
		                    	"Jumlah Bayar		: Rp. ".rupiah($a['jumlah_bayar'])."<br>".
		                    	"Nama Bank	: ".$a['nama_bank']."<br>".
		                    	"Dari Rekening	: ".$a['no_rekening']."<br>".
		                    	"Pembayaran Atas Nama	: ".$a['atas_nama']."<br>".
		                    	"Bank Tujuan	: ".$a['rekening_bank_tujuan']."<br>".
		                    	"Tanggal Pembayaran	: ".$a['tgl_bayar']."<br>".
		                    	"Keterangan	: ".$a['keterangan']."<br>".

		                    	"<hr>".
		                    	"<center>"."<img width='15%' src='img/qrcode/$qr.jpg'>"."<br>".
		                    	"<b>PT Izakat Indonesia"."<br>".
		                    	...
		                    	?>" class="btn btn-success aku"><span class="glyphicon glyphicon-ok"></span> Lunas</a>
		                    	<?php }?>	
