...
if(isset($_POST['submit'])){
 ...
 if(!empty($nama)){
      ...
      if(editprofil($namalengkap,$email,$alamat,$notlp,$id)){
                echo "<script>document.location.href = 'profil.php';</script>";
            }else{
              echo "Error".mysqli_error($konek);
            }
    ...
    <div class="row">
        <div class="col-md-4">
          ...
          <?php while ($row=mysqli_fetch_Assoc($result)) { ?>
              <p><center><img width="140" height="160" src="<?= $row['foto_profil'];?>" alt=""></center></p>
              <p><center><?= $row['namalengkap'];?></center></p>
              <center>
              <label>Email</label>
              <p><?= $row['email'];?></p>
              <label>Alamat</label>
      ...
      <div class="col-md-8">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <table class="table table-bordered">
                      ...
                      <tr>
                        <td>No Telepon</td>
                        <td><input name="no" class="form-control" maxlength="12" type="number" value="<?= $row['no_tlp'];?>"></td>
                      </tr>
